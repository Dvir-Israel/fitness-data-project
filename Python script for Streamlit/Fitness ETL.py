...
def main():
    ...
    # Read Excel files using config paths
    xlweigh_ins = pd.read_excel(cfg["paths"]["weighins_excel"], sheet_name=None)
    xltraining_plan = pd.read_excel(cfg["paths"]["trainingplan_excel"], sheet_name=None)
